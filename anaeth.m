function [ratesNone, ratesAttended] = anaeth(attendLeft, attendRight, attendNone, figtitle)
...
%the logs. 
    ...
    % dprime values;
    rates
    [rates.dpHH, rates.cHH] = dprime_simple(rates.drateHH, max(0.01, rates.frateHH0));
    [rates.dpHL, rates.cHL] = dprime_simple(rates.drateHL, max(0.01, rates.frateHL0));
    [rates.dpLH, rates.cLH] = dprime_simple(rates.drateLH, max(0.01, rates.frateLH0));
    [rates.dpLL, rates.cLL] = dprime_simple(rates.drateLL, max(0.01, rates.frateLL0));
